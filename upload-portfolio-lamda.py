...
def lambda_handler = (event, context):
    ...
    try:
        ...
        print "Job Done!"
        topic.publish(Subject="Portfolio Deployed", Message="Portfolia deployed successfully!")
    except:
        topic.publish(Subject="Portfolio Deployed Failed", Message="Portfolia did not deploy successfully!")
        raise
